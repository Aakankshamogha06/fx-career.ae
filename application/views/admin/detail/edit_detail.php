        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-12">
                ...
                ?>
                    ...
                    <form class="form-horizontal" method="post" action="<?= base_url('detail/detail_update_data'); ?>" enctype="multipart/form-data">
            ...
            <div class="form-row row mb-4">
                       ...
                       <div class="form-row row mb-4"> 
                           <div class="form-group col-md-6">
                               ...
                               <input type="text" name="mode" parsley-trigger="change" class="form-control" id="mode" value=" <?= $row->mode?>" placeholder="No. of Lessons " required>
                               </div>
                           <div class="form-group col-md-6">
                       ...
                       <div class="form-row row mb-4">
                           ...
                           <div class="form-group col-md-6">
                               ...
                               <input type="text" name="status" parsley-trigger="change" class="form-control" id="status" value=" <?= $row->status?>" placeholder="Status " required>
                           </div>
                       </div>
                       <div class="form-row row mb-4">
