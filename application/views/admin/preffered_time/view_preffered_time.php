    ...
    <div class="row g-4 justify-content-center">
      <div class="col-lg-12">
        <div class="bg-secondary rounded p-4">
          ...
          <a href="<?= base_url('admin/preffered_time/add_preffered_time'); ?>">
                ...
                <thead style="color:#FEC83D;">
                  <tr>
                            ...
                            <tbody>
                                <?php
                                $c = 1;
                                foreach ($preffered_time_view as $row) : ?>
                                    <tr>
                                        <td><?= $c++; ?></td>
                                        <td><?= $row->time_slot ?></td>
                                        <td class="text-right"><a href="<?= base_url('admin/preffered_time/preffered_time_edit/' . $row->id); ?>">
                          <i class="fas fa-edit" style="font-size: 24px; color: blue;"></i></a>
                        <a href="<?= base_url('admin/preffered_time/preffered_time_delete/' . $row->id); ?>" onclick="return confirm('Are you sure want to delete ?');">
