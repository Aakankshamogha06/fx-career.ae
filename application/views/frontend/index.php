<main>
   ...
   <!-- hero-area-start -->
   <div class="it-hero-2-area it-hero-2-bg fix p-relative"
      data-background="<?= base_url() ?>public/web/assets/img/hero/hero-bg-1.jpg">
      ...
      <div class="it-hero-2-funfact text-center d-none d-xl-block">
         <span class="theme"><i class="purecounter" data-purecounter-duration="1"
               data-purecounter-end="30">0</i>k+</span>
      ...
      <div class="container">
         <div class="row g-4 it-hero-2-content">
            <div class="col-xl-6 col-lg-6">
               <div class="">
                  <h1 class="it-hero-2-title">Empower
                     ...
                     <br>Forex Trading Career<br>with World-Class Training
                  </h1>
                  <div class="it-hero-2-text">
                     <p>Become a master of Forex Trading and develop Your Trading Skills Across Multiple
                        Asset Classes. Benefit from the wealth of experience and practical knowledge
                        brought to the table by our industry-experienced trainers.
                        FX Careers.ae offers comprehensive online and offline courses designed to transform
                        beginners into skilled traders across various financial markets.</p>
                     <p>Choose from a variety of engaging learning
                        formats, including interactive workshops, video tutorials, and live webinars, all
                        tailored to your experience level, from beginners to advanced. <b>Master the
                           fundamentals and develop practical trading strategies</b> to confidently navigate the
                        ever-changing financial landscape. Get a taste of what FX Careers.ae has to offer
                        with a free demo or trial.
                     </p>
         ...
         <div class="row">
            <div class="col-xl-3 col-lg-3 col-md-6 mb-30">
               <div class="it-category-4-item text-center">
                  <div class="it-category-4-icon">
                     <span>
                        <img src="<?= base_url() ?>public/web/assets/img/category/online-01.png" alt=""
                           class="mb-4">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 mb-30">
               <div class="it-category-4-item text-center">
                  <div class="it-category-4-icon">
                     <span>
                        <img src="<?= base_url() ?>public/web/assets/img/category/classroom-01.png" alt=""
                           class="mb-4">
                        <h4 class="it-category-4-title"><a href="#">Classroom Courses</a></h4>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 mb-30">
               <div class="it-category-4-item text-center">
                  <div class="it-category-4-icon">
                     <span>
                        <img src="<?= base_url() ?>public/web/assets/img/category/self-learning-01.png" alt="" class="mb-4">
                        <h4 class="it-category-4-title"><a href="#">Self Learning</a></h4>
                     </span>
                  </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 mb-30">
               <div class="it-category-4-item text-center">
                  <div class="it-category-4-icon">
                     <span>
                        <img src="<?= base_url() ?>public/web/assets/img/category/one-to-one-session-01.png" alt=""
                           class="mb-4">
            ...
            <div class="col-xl-6 col-lg-6">
               <div class="it-about-right-box">
                  <div class="it-about-title-box mb-20">
                     ...
                     <h4 class="it-section-title">We Empower Your
                        <span class="p-relative z-index">learning
                           <svg class="title-shape-2" width="168" height="65" viewBox="0 0 168 65" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                              <path
                                 d="M73.3761 8.49147C78.4841 6.01353 82.5722 4.25154 88.8933 3.3035C94.2064 2.50664 99.6305 2.0701 104.981 1.94026C120.426 1.56549 135.132 4.90121 146.506 9.70405C158.628 14.8228 166.725 22.5638 166.074 31.6501C165.291 42.5779 151.346 51.7039 133.508 56.8189C110.253 63.4874 81.7065 63.8025 58.5605 60.8285C37.5033 58.123 11.6304 51.7165 3.58132 40.0216C-3.43085 29.8337 12.0728 18.1578 27.544 11.645C40.3656 6.24763 55.7082 2.98328 70.8043 4.08403C81.9391 4.89596 93.2164 6.87822 102.462 9.99561C112.874 13.5066 120.141 18.5932 127.862 23.6332"
                        ...
                        <br>Journey with the best Courses
                     </h4>
                  </div>
                  ...
                  <div class="it-about-content-wrapper d-flex align-items-center justify-content-between pb-15">
                     <div class="it-about-content">
                        <h5>Master the Markets</h5>
                        <p>Conquer the dynamic world of Forex, stocks and
                           commodities with confidence. Learn from industry leaders and
                           develop the skills to navigate these markets effectively.</p>
                     </div>
                     <div class="it-about-content">
                        <h5>Unlock Potential</h5>
   ...
   <div class="it-video-area it-video-bg p-relative fix pt-100 pb-95"
      data-background="<?= base_url() ?>public/web/assets/img/video/bg-1-1.jpg">
            ...
            <div class="col-xl-6 col-lg-6 mb-30">
               <div class="it-choose-left">
                  <div class="it-choose-title-box mb-30">
                     ...
                     <h4 class="it-section-title">Learn from Expert Market
                        <span class="p-relative z-index">Professionals
                  ...
                  <div class="it-choose-text pb-15">
                     <p>Our seasoned Forex professionals provide comprehensive training, from basics to advanced
                     ...
                     <div class="row gx-20">
                        ...
                        <div class="col-md-6 col-sm-6 mb-20">
                           <div class="it-choose-content">
                              ...
                              <p>Simplified curriculum designed for quick understanding and practical application</p>
                           </div>
                        </div>
                        <div class="col-md-6 col-sm-6 mb-20">
                           <div class="it-choose-content">
                        ...
                        <div class="col-md-6 col-sm-6 mb-20">
                           <div class="it-choose-content">
                              ...
                              <p>High-quality Forex education accessible at competitive, budget-friendly rates</p>
                           </div>
                        </div>
                     </div>
                  </div>
   ...
   <div class="it-testimonial-area it-testimonial-ptb it-testimonial-bg fix p-relative"
            ...
            <div class="col-xl-5 col-lg-5">
               <div class="it-team-left">
                  ...
                  <div class="it-team-button">
                     ...
                     <a class="it-btn black-bg" href="<?= base_url() ?>courses">
                        <span>
                           Explore courses
                           <svg width="17" height="14" viewBox="0 0 17 14" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                                 ...
                                 <div class="it-team-author-box d-flex align-items-center justify-content-between">
                                    <div class="it-team-author-info">
                                       <h4 class="it-team-3-title"><a
                                             href="<?= base_url() ?>mentor/<?= str_replace(' ', '-', strtolower($row->teacher_name)); ?>"
                                             style="color: black;"><?= $row->teacher_name ?></a></h4>
                  ...
                  <?php foreach ($blog_detail_view as $row): ?>
                     <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                        <div class="it-blog-item-box"
                           data-background="<?= base_url() ?>public/web/assets/img/blog/bg-1.jpg">
                           <div class="it-blog-item">
                              <div class="it-blog-thumb fix">
                                 <a
                                    href="<?= base_url() ?>blog/<?= str_replace(' ', '-', strtolower($row->blog_name)); ?>">
                              ...
                              <h4 class="it-blog-title line-clamp-2"><a
                                    href="<?= base_url('blog/') ?><?= str_replace(' ', '-', strtolower($row->blog_name)); ?>"><?= substr($row->blog_name, 0, 10) . '..' ?></a>
                              </h4>
                              <a class="it-btn sm"
                                 href="<?= base_url('blog/') ?><?= str_replace(' ', '-', strtolower($row->blog_name)); ?>">
                                 <span>
