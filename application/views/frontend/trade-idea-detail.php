         ...
         <div class="col-md-12">
            <div class="it-breadcrumb-content z-index-3 text-center">
               <div class="it-breadcrumb-title-box">
                  <h3 class="it-breadcrumb-title">Trade Idea Detail</h3>
               </div>
               <div class="it-breadcrumb-list-wrap">
                  <div class="it-breadcrumb-list">
                     <span><a href="<?=base_url()?>">home</a></span>
                     <span class="dvdr">//</span>
                     <span>Trade Idea Detail</span>
                  </div>
               </div>
            </div>
         </div>
                     ...
                     <?php foreach ($trade_ideas as $trade_idea): ?>
                        <div class="rc__post mb-30 d-flex align-items-start">
                           <div class="rc__post-thumb mr-20">
                              <a href="<?=base_url()?>trade-idea/<?=str_replace(' ','-',strtolower($row->trade_name));?>">
                           ...
                           <div class="rc__post-content">
                              ...
                              <h3 class="rc__post-title">
                                 <a href="<?=base_url()?>trade-idea/<?=str_replace(' ','-',strtolower($row->trade_name));?>"><?=$trade_idea->trade_name?></a>
                              </h3>
                           </div>
                        </div>
                        <?php endforeach?>
